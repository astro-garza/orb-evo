...
def initcon():
    ...
    sim.add(m=m_p,r=r_pl, hash="STAR") #Proxima Centauri b (1.5 Me, r=4.6846e-5)
    ...
    while sim.N < (21):
        ...
        sim.add(m=m_e,r=r_e,a=a,e=e,inc=inc,Omega=0, omega=0,f=f)#, hash=b)
        b += 1
...
for i, time in enumerate(times):
    ...
    tst = str(sim.t)
    active = sim.N_active
    print "Active Particles: "+str(active)
    print "#######################################################"
